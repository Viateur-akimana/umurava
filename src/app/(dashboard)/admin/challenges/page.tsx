    ...
    <div className="flex-1 px-6 py-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 mb-4">
        ...
        <Link 
          ...
          className="flex items-center justify-center bg-[#2B71F0] font-semibold text-lg text-white p-4 gap-1 rounded hover:bg-[#2B71F0]/90 transition-colors"
        >
          <Plus />
        ...
        <>
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              disabled={page === 1}
              className="px-4 py-2 mx-1 border rounded-lg disabled:opacity-50 hover:bg-gray-50 transition-colors"
            >
              Previous
            </button>
