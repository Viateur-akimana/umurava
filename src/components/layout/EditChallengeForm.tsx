...
const EditChallengeForm: React.FC<EditChallengeFormProps> = ({ challenge }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    await handleUpdateChallenge(challenge._id, formattedData, token);
  };
    ...
    <div className="w-full flex justify-center mx-auto my-6 items-center min-h-screen">
      <div className="bg-white py-6 px-4 lg:px-6 md:px-4 rounded-xl border w-full lg:w-3/5 md:w-4/5">
        ...
        <form className="px-4 space-y-4" onSubmit={handleSubmit}>
          {/* <div className="space-y-2">
            <label htmlFor="title" className="block text-lg text-gray-600">Challenge Title</label>
            <input type="text" name="title" value={formData.title} onChange={handleChange} className="border border-gray-400 rounded-lg w-full px-3 py-2 outline-none focus:border-red-300 text-lg" />
          </div>
          <div className="flex items-center w-full gap-4">
            <div className="flex-1 space-y-2">
              <label htmlFor="deadline" className="block text-lg text-gray-600">Deadline</label>
              <input type="text" name="deadline" value={formData.deadline} onChange={handleChange} className="border border-gray-400 rounded-lg w-full px-3 py-2 outline-none focus:border-red-300 text-lg" />
            </div>
            <div className="flex-1 space-y-2">
              <label htmlFor="duration" className="block text-lg text-gray-600">Duration</label>
              <input type="text" name="duration" value={formData.duration} onChange={handleChange} className="border border-gray-400 rounded-lg w-full px-3 py-2 outline-none focus:border-red-300 text-lg" />
            </div>
          </div>
          <div className="flex items-center w-full gap-4">
            <div className="flex-1 space-y-2">
              <label htmlFor="prize" className="block text-lg text-gray-600">Money Prize</label>
              <input type="text" name="prize" value={formData.prize} onChange={handleChange} className="border border-gray-400 rounded-lg w-full px-3 py-2 outline-none focus:border-red-300 text-lg" />
            </div>
            <div className="flex-1 space-y-2">
              <label htmlFor="contactEmail" className="block text-lg text-gray-600">Contact Email</label>
              <input type="text" name="contactEmail" value={formData.contactEmail} onChange={handleChange} className="border border-gray-400 rounded-lg w-full px-3 py-2 outline-none focus:border-red-300 text-lg" />
            </div>
          </div>
          <div className="py-3 space-y-2">
            <label htmlFor="projectBrief" className="block text-lg text-gray-600">Project Brief</label>
            <textarea name="projectBrief" value={formData.projectBrief} onChange={handleChange} className="border border-gray-400 rounded-lg w-full px-3 py-4 text-gray-500 outline-none focus:border-red-300 text-lg" rows={5} />
          </div>
          <div className="py-3 space-y-2">
            <label htmlFor="projectDescription" className="block text-lg text-gray-600">Project Description</label>
            <textarea name="projectDescription" value={formData.projectDescription} onChange={handleChange} className="border border-gray-400 rounded-lg w-full px-3 py-4 text-gray-500 outline-none focus:border-red-300 text-lg" rows={5} />
          </div>
          {error && <p className="text-red-500">{error}</p>}
          {success && <p className="text-green-500">Challenge updated successfully!</p>}
          <div className="flex items-center gap-8 w-full py-8">
            <button type="button" className="border-2 border-[#2B71F0] bg-white hover:bg-[#2B71F0] hover:text-white duration-500 text-[#2B71F0] rounded-lg py-4 px-6 text-lg w-1/3">
              Cancel
            </button>
            <button type="submit" className="border-2 border-[#2B71F0] bg-[#2B71F0] hover:bg-blue-800 duration-500 text-white rounded-lg py-4 px-6 text-lg" disabled={loading}>
